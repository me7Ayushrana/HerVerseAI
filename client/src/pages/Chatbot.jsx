...
`;
      ...
      // Run local fallback if no API key is configured
      setTimeout(() => {
        runFallback(userText, chatHistory);
        setIsLoading(false);
      }, 600);
  ...
  const runFallback = (userText, chatHistory) => {
    ...
    } else if (msgLower.includes('diet') || msgLower.includes('nutrition') || msgLower.includes('eat') || msgLower.includes('food') || msgLower.includes('meal') || msgLower.includes('water') || msgLower.includes('calor')) {
